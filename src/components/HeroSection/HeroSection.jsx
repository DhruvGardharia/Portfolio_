      ...
      <div className="hero-layout">
        ...
        <div className="hero-content">
          ...
          <div className="hero-socials">
            {/* INSTRUCTIONS FOR YOU (DHRUV): */}
            {/* Update the `href` values below with your actual profile links! */}
            <a href="mailto:dhruvgardharia1611@gmail.com" target="_blank" rel="noreferrer" className="social-icon" aria-label="Email">
            ...
            <a href="https://github.com/DhruvGardharia" target="_blank" rel="noreferrer" className="social-icon" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/dhruv-gardharia-b3596831b/" target="_blank" rel="noreferrer" className="social-icon" aria-label="LinkedIn">
            ...
            <a href="https://leetcode.com/u/Dhruv1611" target="_blank" rel="noreferrer" className="social-icon" aria-label="LeetCode">
