      ...
      <div className="hero-layout">
        ...
        <div className="hero-content">
          ...
          <div className="hero-socials">
            ...
            <a href="mailto:your.email@example.com" target="_blank" rel="noreferrer" className="social-icon" aria-label="Email">
            ...
            <a href="https://leetcode.com/YourUsername/" target="_blank" rel="noreferrer" className="social-icon" aria-label="LeetCode">
